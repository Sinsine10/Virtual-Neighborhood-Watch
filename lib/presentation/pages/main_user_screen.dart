...
import 'user_reports.dart'; // Adjust the path based on your structure
...
class MainUserScreen extends StatelessWidget {
        ...
        child: Stack(
          children: [
            ...
            Align(
              ...
              child: Image.asset(
                'assets/rectangle.png', // Make sure this image exists
                fit: BoxFit.cover,
  ...
  children: [
    Image.asset(
      'assets/iconn.png', // Replace with your actual icon image
      width: 70,
      height: 70,
    ),
